...
sitting open, every one needing a site visit, worked roughly in the order they
arrive. So a tree that fell on a house last night queues behind a nine-month-old
request to trim a hedge.
...
290-request backlog: not by working faster, but by making every trip count for
more.
